...
class PreDefinedStrategyTest
{
    PreDefinedStrategy strategy = new PreDefinedStrategy();

    /**
     *  This test should produce an output of 2.
     */
    @Test
    void testFirstMove()
    {
        ...
        while (loop <= 5)
        {
            ...
            // The predefined move should return 2 with 10 matchsticks.
            assertEquals(2, move);
    ...
    void testLastMove()
    {
        ...
        while (loop <= 5)
        {
            ...
            // The predefined move should only return 1.
            assertEquals(1, move);
